...
import 'package:flutter_commerce/components/rounded_icon_btn.dart';
...
class ColorDots extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...List.generate(product.colors.length, (index) => ColorDot(color: product.colors[index], isSelected: index == selectedColor,)),
          Spacer(),
          RoundedIconBtn(icon: Icons.remove, press: () {}),
          SizedBox(width: getProportionateScreenWidth(20),),
          RoundedIconBtn(icon: Icons.add, press: (){}, showShadow: true,)
        ],
      ),
    );
  }
